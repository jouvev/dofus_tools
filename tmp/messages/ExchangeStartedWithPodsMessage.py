...
class ExchangeStartedWithPodsMessage(ExchangeStartedMessage):
   ...
   def _firstCharacterIdFunc(self,input) :
      ...
      if(self.firstCharacterId < -9007199254740992 or self.firstCharacterId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.firstCharacterId + ") on element of ExchangeStartedWithPodsMessage.firstCharacterId.")
   ...
   def _firstCharacterCurrentWeightFunc(self,input) :
      ...
      if(self.firstCharacterCurrentWeight < 0) :
         raise RuntimeError("Forbidden value (" + self.firstCharacterCurrentWeight + ") on element of ExchangeStartedWithPodsMessage.firstCharacterCurrentWeight.")
   ...
   def _firstCharacterMaxWeightFunc(self,input) :
      ...
      if(self.firstCharacterMaxWeight < 0) :
         raise RuntimeError("Forbidden value (" + self.firstCharacterMaxWeight + ") on element of ExchangeStartedWithPodsMessage.firstCharacterMaxWeight.")
   ...
   def _secondCharacterIdFunc(self,input) :
      ...
      if(self.secondCharacterId < -9007199254740992 or self.secondCharacterId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.secondCharacterId + ") on element of ExchangeStartedWithPodsMessage.secondCharacterId.")
   ...
   def _secondCharacterCurrentWeightFunc(self,input) :
      ...
      if(self.secondCharacterCurrentWeight < 0) :
         raise RuntimeError("Forbidden value (" + self.secondCharacterCurrentWeight + ") on element of ExchangeStartedWithPodsMessage.secondCharacterCurrentWeight.")
   ...
   def _secondCharacterMaxWeightFunc(self,input) :
      ...
      if(self.secondCharacterMaxWeight < 0) :
         raise RuntimeError("Forbidden value (" + self.secondCharacterMaxWeight + ") on element of ExchangeStartedWithPodsMessage.secondCharacterMaxWeight.")