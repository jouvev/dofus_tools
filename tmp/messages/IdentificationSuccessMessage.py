...
class IdentificationSuccessMessage:
   ...
   def _accountIdFunc(self,input) :
      ...
      if(self.accountId < 0) :
         raise RuntimeError("Forbidden value (" + self.accountId + ") on element of IdentificationSuccessMessage.accountId.")
   
   def _communityIdFunc(self,input) :
      self.communityId = input.readByte()
      if(self.communityId < 0) :
         raise RuntimeError("Forbidden value (" + self.communityId + ") on element of IdentificationSuccessMessage.communityId.")
   ...
   def _accountCreationFunc(self,input) :
      ...
      if(self.accountCreation < 0 or self.accountCreation > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.accountCreation + ") on element of IdentificationSuccessMessage.accountCreation.")
   ...
   def _subscriptionElapsedDurationFunc(self,input) :
      ...
      if(self.subscriptionElapsedDuration < 0 or self.subscriptionElapsedDuration > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.subscriptionElapsedDuration + ") on element of IdentificationSuccessMessage.subscriptionElapsedDuration.")
   ...
   def _subscriptionEndDateFunc(self,input) :
      ...
      if(self.subscriptionEndDate < 0 or self.subscriptionEndDate > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.subscriptionEndDate + ") on element of IdentificationSuccessMessage.subscriptionEndDate.")
   ...
   def _havenbagAvailableRoomFunc(self,input) :
      ...
      if(self.havenbagAvailableRoom < 0 or self.havenbagAvailableRoom > 255) :
         raise RuntimeError("Forbidden value (" + self.havenbagAvailableRoom + ") on element of IdentificationSuccessMessage.havenbagAvailableRoom.")