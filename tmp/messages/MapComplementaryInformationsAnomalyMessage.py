...
class MapComplementaryInformationsAnomalyMessage(MapComplementaryInformationsDataMessage):
   ...
   def _levelFunc(self,input) :
      ...
      if(self.level < 0) :
         raise RuntimeError("Forbidden value (" + self.level + ") on element of MapComplementaryInformationsAnomalyMessage.level.")
   ...
   def _closingTimeFunc(self,input) :
      ...
      if(self.closingTime < 0 or self.closingTime > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.closingTime + ") on element of MapComplementaryInformationsAnomalyMessage.closingTime.")