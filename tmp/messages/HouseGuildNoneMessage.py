class HouseGuildNoneMessage:
   ...
   def _houseIdFunc(self,input) :
      ...
      if(self.houseId < 0) :
         raise RuntimeError("Forbidden value (" + self.houseId + ") on element of HouseGuildNoneMessage.houseId.")
   
   def _instanceIdFunc(self,input) :
      self.instanceId = input.readInt()
      if(self.instanceId < 0) :
         raise RuntimeError("Forbidden value (" + self.instanceId + ") on element of HouseGuildNoneMessage.instanceId.")
