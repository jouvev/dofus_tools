class GroupTeleportPlayerOfferMessage:
   ...
   def _mapIdFunc(self,input) :
      ...
      if(self.mapId < 0 or self.mapId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.mapId + ") on element of GroupTeleportPlayerOfferMessage.mapId.")
   ...
   def _timeLeftFunc(self,input) :
      ...
      if(self.timeLeft < 0) :
         raise RuntimeError("Forbidden value (" + self.timeLeft + ") on element of GroupTeleportPlayerOfferMessage.timeLeft.")
   ...
   def _requesterIdFunc(self,input) :
      ...
      if(self.requesterId < 0 or self.requesterId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.requesterId + ") on element of GroupTeleportPlayerOfferMessage.requesterId.")
