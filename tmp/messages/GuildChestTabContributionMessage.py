class GuildChestTabContributionMessage:
   ...
   def _tabNumberFunc(self,input) :
      ...
      if(self.tabNumber < 0) :
         raise RuntimeError("Forbidden value (" + self.tabNumber + ") on element of GuildChestTabContributionMessage.tabNumber.")
   ...
   def _requiredAmountFunc(self,input) :
      ...
      if(self.requiredAmount < 0 or self.requiredAmount > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.requiredAmount + ") on element of GuildChestTabContributionMessage.requiredAmount.")
   ...
   def _currentAmountFunc(self,input) :
      ...
      if(self.currentAmount < 0 or self.currentAmount > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.currentAmount + ") on element of GuildChestTabContributionMessage.currentAmount.")
   ...
   def _chestContributionEnrollmentDelayFunc(self,input) :
      ...
      if(self.chestContributionEnrollmentDelay < 0 or self.chestContributionEnrollmentDelay > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.chestContributionEnrollmentDelay + ") on element of GuildChestTabContributionMessage.chestContributionEnrollmentDelay.")
   ...
   def _chestContributionDelayFunc(self,input) :
      ...
      if(self.chestContributionDelay < 0 or self.chestContributionDelay > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.chestContributionDelay + ") on element of GuildChestTabContributionMessage.chestContributionDelay.")