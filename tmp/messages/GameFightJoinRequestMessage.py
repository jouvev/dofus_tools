class GameFightJoinRequestMessage:
   ...
   def _fighterIdFunc(self,input) :
      ...
      if(self.fighterId < -9007199254740992 or self.fighterId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.fighterId + ") on element of GameFightJoinRequestMessage.fighterId.")
   
   def _fightIdFunc(self,input) :
      self.fightId = input.readVarUhShort()
      if(self.fightId < 0) :
         raise RuntimeError("Forbidden value (" + self.fightId + ") on element of GameFightJoinRequestMessage.fightId.")