class AchievementAchieved:
   ...
   def _idFunc(self,input) :
      ...
      if(self.id < 0) :
         raise RuntimeError("Forbidden value (" + self.id + ") on element of AchievementAchieved.id.")
   ...
   def _achievedByFunc(self,input) :
      ...
      if(self.achievedBy < 0 or self.achievedBy > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.achievedBy + ") on element of AchievementAchieved.achievedBy.")