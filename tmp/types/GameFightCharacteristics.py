...
class GameFightCharacteristics:
   ...
   def _summonerFunc(self,input) :
      ...
      if(self.summoner < -9007199254740992 or self.summoner > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.summoner + ") on element of GameFightCharacteristics.summoner.")
   ...
   def _invisibilityStateFunc(self,input) :
      ...
      if(self.invisibilityState < 0) :
         raise RuntimeError("Forbidden value (" + self.invisibilityState + ") on element of GameFightCharacteristics.invisibilityState.")