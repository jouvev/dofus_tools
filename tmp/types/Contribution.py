class Contribution:
   ...
   def _contributorIdFunc(self,input) :
      ...
      if(self.contributorId < 0 or self.contributorId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.contributorId + ") on element of Contribution.contributorId.")
   ...
   def _amountFunc(self,input) :
      ...
      if(self.amount < 0 or self.amount > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + self.amount + ") on element of Contribution.amount.")