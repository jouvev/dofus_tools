class GroupTeleportPlayerCloseMessage:
   ...
   def _mapIdFunc(self,input) :
      ...
      if(self.mapId < 0 or self.mapId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + str(self.mapId) + ") on element of GroupTeleportPlayerCloseMessage.mapId.")
   ...
   def _requesterIdFunc(self,input) :
      ...
      if(self.requesterId < 0 or self.requesterId > 9007199254740992) :
         raise RuntimeError("Forbidden value (" + str(self.requesterId) + ") on element of GroupTeleportPlayerCloseMessage.requesterId.")
