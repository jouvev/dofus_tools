class GuildInformationsGeneralMessage:
   ...
   def resume(self):
      print("abandonnedPaddock :",self.abandonnedPaddock)
      print("level :",self.level)
      print("expLevelFloor :",self.expLevelFloor)
      print("experience :",self.experience)
      print("expNextLevelFloor :",self.expNextLevelFloor)
      print("creationDate :",self.creationDate)
      print("nbTotalMembers :",self.nbTotalMembers)
