from src.reseau.protocoltype.GameFightFighterNamedInformations import GameFightFighterNamedInformations
from src.reseau.protocoltype.ActorAlignmentInformations import ActorAlignmentInformations
